...
export const metadata: Metadata = {
  title: "Furnish & Find",
  description: "A modern and responsive website By Arsalan Ahmed built with Next.js.",
  openGraph: {
    title: "Furnish & Find",
    description: "A modern and responsive website Arsalan Ahmed built with Next.js.",
